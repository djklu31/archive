    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script> <script src="jquery.backstretch.min.js"></script>
		 <script> $.backstretch("dim.jpg"); </script>
...
<div class="container">
    ...
    <div class="jumbotron rates">
        <h1>Rates</h1>
        <p class="pcenter">Men's Haircut: $50.00</p>
        <p class="pcenter">Woman's Haircut: $50.00</p>
        <p class="pcenter">Hair Color: $75.00</p>
        <p class="pcenter">Blowdry: +$5.00</p>
        <br>
        <p class="pcenter">Massage: $60.00/hr</p>
        <p class="pcenter"><a class="btn btn-lg btn-primary" href="bookappt.php" role="button">Book an Appointment</a></p>
      </div>
  </div>
