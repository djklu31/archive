...
<div class="container">
    <div class="jumbotron">
        <h1>Wynn Salon and Spa</h1>
        <p class="pcenter">We are currently offering 20% off all hair cuts.</p>
        <p class="pcenter">Please visit our Special Offers page or click the link below.</p>
            <p class="pcenter"><a class="btn btn-lg btn-primary" href="specialoffers.php" role="button">Find Out How!</a></p>
        </p>
  </div>
</div>
